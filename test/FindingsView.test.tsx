...
test('renders empty state when no tasks', () => {
  render(<FindingsView tasks={[]} checklists={[]} users={[baseUser]} onResolveTask={async () => {}} onAssignTask={async () => {}} />)
...
test('renders a finding card and supports filter', () => {
  ...
  render(<FindingsView tasks={[task]} checklists={[checklist]} users={[baseUser]} onResolveTask={async () => {}} onAssignTask={async () => {}} />)
