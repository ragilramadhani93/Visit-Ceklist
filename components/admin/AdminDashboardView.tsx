...
const AdminDashboardView: React.FC<AdminDashboardViewProps> = ({ setView }) => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-neutral">Admin Dashboard</h2>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total Users" value="152" icon={<Users className="text-white" />} color="bg-blue-500" />
