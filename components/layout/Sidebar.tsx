...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, isOpen, setIsOpen, user, onLogout }) => {
    ...
    const getNavItems = (role: Role) => {
        const allItems = [
            ...
            { id: 'findings' as View, label: 'Findings', icon: <ClipboardList size={20} />, roles: [Role.Admin] },
            { id: 'reports' as View, label: 'Reports', icon: <BarChart3 size={20} />, roles: [Role.Admin] },
